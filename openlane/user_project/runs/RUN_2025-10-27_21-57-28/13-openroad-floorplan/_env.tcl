set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NETLIST) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/06-yosys-synthesis/user_project.nl.v
set ::env(SAVE_ODB) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/13-openroad-floorplan/user_project.odb
set ::env(SAVE_DEF) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/13-openroad-floorplan/user_project.def
set ::env(SAVE_SDC) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/13-openroad-floorplan/user_project.sdc
set ::env(SAVE_NETLIST) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/13-openroad-floorplan/user_project.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_21-57-28/13-openroad-floorplan/user_project.pnl.v
