...
set ::env(CURRENT_ODB) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_23-02-00/41-odb-heuristicdiodeinsertion/2-openroad-detailedplacement/user_project.odb
set ::env(SAVE_ODB) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_23-02-00/41-odb-heuristicdiodeinsertion/3-openroad-globalrouting/user_project.odb
set ::env(SAVE_DEF) /workspace/peripheral-example/openlane/user_project/runs/RUN_2025-10-27_23-02-00/41-odb-heuristicdiodeinsertion/3-openroad-globalrouting/user_project.def
