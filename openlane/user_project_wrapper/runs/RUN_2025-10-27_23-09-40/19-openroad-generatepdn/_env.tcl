set ::env(FP_PDN_CFG) /nix/store/z6z1ia207zpd43ka6vqnxgghfxfr26h6-python3-3.11.9-env/lib/python3.11/site-packages/librelane/scripts/openroad/common/pdn_cfg.tcl
...
set ::env(MACRO_LEFS) /workspace/peripheral-example/lef/user_project.lef
...
set ::env(MACROS) "user_project \"gds /workspace/peripheral-example/gds/user_project.gds lef /workspace/peripheral-example/lef/user_project.lef instances \\\"mprj \\\\\\\"location \\\\\\\\\\\\\\\"60 15\\\\\\\\\\\\\\\" orientation N\\\\\\\"\\\" vh \\\"\\\" nl /workspace/peripheral-example/verilog/gl/user_project.v pnl \\\"\\\" spef \\\"\\\\\\\"min_*\\\\\\\" /workspace/peripheral-example/spef/multicorner/user_project.min.spef \\\\\\\"nom_*\\\\\\\" /workspace/peripheral-example/spef/multicorner/user_project.nom.spef \\\\\\\"max_*\\\\\\\" /workspace/peripheral-example/spef/multicorner/user_project.max.spef\\\" lib \\\"\\\\\\\"*\\\\\\\" /workspace/peripheral-example/lib/user_project.lib\\\" spice \\\"\\\" sdf \\\"\\\" json_h None\""
...
set ::env(PDN_MACRO_CONNECTIONS) "\"mprj vccd1 vssd1 VPWR VGND\""
set ::env(PDN_ENABLE_GLOBAL_CONNECTIONS) 1
set ::env(PNR_SDC_FILE) /workspace/peripheral-example/openlane/user_project_wrapper/signoff.sdc
set ::env(FP_DEF_TEMPLATE) /workspace/peripheral-example/openlane/user_project_wrapper/fixed_dont_change/user_project_wrapper.def
...
set ::env(CURRENT_ODB) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-09-40/17-openroad-cutrows/user_project_wrapper.odb
set ::env(SAVE_ODB) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-09-40/19-openroad-generatepdn/user_project_wrapper.odb
set ::env(SAVE_DEF) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-09-40/19-openroad-generatepdn/user_project_wrapper.def
set ::env(SAVE_SDC) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-09-40/19-openroad-generatepdn/user_project_wrapper.sdc
set ::env(SAVE_NETLIST) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-09-40/19-openroad-generatepdn/user_project_wrapper.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-09-40/19-openroad-generatepdn/user_project_wrapper.pnl.v
