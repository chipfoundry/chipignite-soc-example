set ::env(TRACKS_INFO_FILE_PROCESSED) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/13-openroad-floorplan/config.tracks
...
set ::env(CURRENT_NETLIST) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/06-yosys-synthesis/user_project_wrapper.nl.v
set ::env(SAVE_ODB) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/13-openroad-floorplan/user_project_wrapper.odb
set ::env(SAVE_DEF) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/13-openroad-floorplan/user_project_wrapper.def
set ::env(SAVE_SDC) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/13-openroad-floorplan/user_project_wrapper.sdc
set ::env(SAVE_NETLIST) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/13-openroad-floorplan/user_project_wrapper.nl.v
set ::env(SAVE_POWERED_NETLIST) /workspace/peripheral-example/openlane/user_project_wrapper/runs/RUN_2025-10-27_23-13-28/13-openroad-floorplan/user_project_wrapper.pnl.v
